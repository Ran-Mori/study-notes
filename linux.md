...
* "/etc"  系统主要的配置文件，例如人员的账号密码文件、各种服务的起始文件等
* "/home"  所有普通用户默认的工作目录
* "/media"   设备目录，比如U盘
* "/lib"   存放系统最根本的动态链接库
* "/root"  root用户的home目录
...
* 改变文件的拥有者 **chown  IzumiSakai  test.json**
* 改变文件的组别  **chgrp  IzumiSakai  test.json**
* 改变所有者文件权限  **chmod  u [+, -]  [r, w, x ]  test,json**
* 改变所属组的权限  **chmod  g [+, -]  [r, w, x ]  test,json**